...
Tab2:AddButton({
    Name = "Ativar Fly GUI",
    Description = "Carrega painel adm ",
    Callback = function()
        local success, _ = loadstring(game:HttpGet("https://raw.githubusercontent.com/cinthiaolirocha-png/Veloz-free-adm/refs/heads/main/README.md"))()
        end)
